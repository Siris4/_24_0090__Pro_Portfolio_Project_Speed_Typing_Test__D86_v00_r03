...
def start_test():
 global start_time, random_template
...
# timer label to show the remaining time
timer_label = tk.Label(root, text="Time left: 60s", bg="#FFFACD", fg="black", font=("Helvetica", 16))
